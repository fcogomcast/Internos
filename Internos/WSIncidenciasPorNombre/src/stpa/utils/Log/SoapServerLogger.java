 ...
 */
public class SoapServerLogger implements ILogger{
	...
	private final static String LOG_DIR = "proyectos/WSIncidenciasPorNombre";

	public enum LEVEL {NONE,FINE, INFO, WARNING, SEVERE,ALL}

	/**
	 * Método que realiza log (sincronizado)
	 */
	public final synchronized static void doLog(String message, LEVEL level){
        ...
        try{
            Date today = new Date();
            String completeMsg = "Consulta de incidencias :: " + today + " :: " + level + " :: " + message;

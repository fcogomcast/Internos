...
public class ConversorParametrosLanzador 
{
	...
	public String getNodoResultado(String nombreNodo)
	{
		...
		String nombreNodoMayus = nombreNodo;
		nombreNodoMayus = nombreNodoMayus.toUpperCase();
		aux = aux.toUpperCase();
		//Logger.info("resultado="+aux);
	...
	/**
	 * Recupera un bloque "estruc" de la respuesta de lanzador con el nombre que se le indica.
	 * @param nombreEstructura Nombre de la estructura a recuperar.
	 * @return La estructura, con todos sus datos o null si no se encuentra la estructura en la respuesta de lanzador.
	 */
	public Node getEstruct (String nombreEstructura)
	{
		Node estruc=null;
		if (this.m_resultadoXML!=null)
		{
			estruc = XMLUtils.selectSingleNode(this.m_resultadoXML, "//estruc[@nombre='"+nombreEstructura+"']");
		}
		return estruc;
	}
	/**
	 * Recupera una fila concreta dentro de un nodo estructura
	 * @param estructura Nodo conteniendo una estructura (estruc) de respuesta de lanzador
	 * @param numFila Número de fila a recuperar.
	 * @return La fila, o null si no se encuentra ese número de fila.
	 */
	public Node getFila (Node estructura, int numFila)
	{
		if (estructura==null)
		{
			return null;
		}
		Node fila = XMLUtils.selectSingleNode(estructura, "fila["+numFila+"]");
		return fila;
	}
	/**
